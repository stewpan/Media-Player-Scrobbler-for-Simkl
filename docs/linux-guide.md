...
- **Configuration file**: `~/.simkl-mps/.simkl_mps.env`
- **Log files**: `~/.simkl-mps/simkl_mps.log`
- **Backlog database**: `~/.simkl-mps/backlog.db`
...
1. View logs in real-time with:
   ```bash
   tail -f ~/.simkl-mps/simkl_mps.log
   ```

2. Or open in your text editor:
   ```bash
   xdg-open ~/.simkl-mps/simkl_mps.log
   ```
